  ...
  return (
    <div className="flex flex-col justify-start items-center min-h-screen bg-gradient-to-r from-black to-white pt-20">
      ...
      <div className="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 mb-8 transition-transform transform hover:scale-105">
        <h2 className="text-3xl font-bold text-center text-black mb-4">True Worship</h2>
        <p className="text-lg text-gray-700 text-center hover:text-teal-500 transition duration-300">
          True worship is not about the show,<br/>
          Or the grandeur of our earthly glow.<br/>
          It's about the sacrifice we bring,<br/>
          To honor our Lord, our everything.<br/>
          It's giving up our selfish desires,<br/>
          And letting go of worldly fires.<br/>
        </p>
      </div>
      ...
      <div className="w-full max-w-lg bg-white shadow-lg rounded-lg p-6 mb-8 transition-transform transform hover:scale-105">
        <h2 className="text-3xl font-bold text-center text-black mb-4">True Worship</h2>
        <p className="text-lg text-gray-700 text-center hover:text-teal-500 transition duration-300">
          True worship is not in a place,<br/>
          But in the heart's deep embrace.<br/>
          It's not in rituals or form,<br/>
          But in a life that's been transformed.<br/>
          It's worshiping God with all we are,<br/>
          In spirit and truth, both near and far.<br/>
        </p>
      </div>
